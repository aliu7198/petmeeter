...
class User(db.Model, UserMixin):
    ...
    desired_pet = db.Column(db.String(50))
    pet_owner = db.Column(db.String(50))
    kids = db.Column(db.Boolean)
    owner_type = db.Column(db.String(50))
    current_pets = db.Column(db.String(50))
    age_pref = db.Column(db.String(10))
    gender_pref = db.Column(db.String(10))
    size_pref = db.Column(db.String(15))
    special_needs = db.Column(db.Boolean)
    breed = db.Column(db.String(100))

    # Dog Specific
    private_outdoor = db.Column(db.String(100))
    shared_outdoor = db.Column(db.String(100))
    lease_restriction = db.Column(db.Boolean)
    breed_restriction = db.Column(db.String(2000))
    size_restriction = db.Column(db.Integer)
    activity_level_pref = db.Column(db.String(25))
