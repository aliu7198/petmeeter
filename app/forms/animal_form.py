...
class AnimalForm(FlaskForm):
    type = SelectField("Type", validators=[DataRequired()], choices=["Dog", "Cat", "Rabbit", "Small & Furry", "Horse", "Bird", "Scales, Fins, & Other", "Barnyard"])
    ...
    adoption_fee = DecimalField("Adoption Fee", places=2, validators=[DataRequired(), NumberRange(min=1)])
